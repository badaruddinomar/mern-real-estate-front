...
const EditListing = () => {
  ...
  const editListingHandler = async (e) => {
    try {
      e.preventDefault();
      const url = `${backendUrl}/api/v1/listing/edit-listing/${id}`;
      const options = {
        method: "PUT",
      ...
      {loading ? (
        ...
        <div className="edit-listing-page">
          ...
          <div className="container">
            <form onSubmit={editListingHandler}>
              {/* left part-- */}
                ...
                <div className="second-div">
                  <div>
                    <input
                      type="checkbox"
                      id="sell"
                      checked={formData.type === "sell" ? true : false}
                  ...
                  <div>
                    <input
                      type="checkbox"
                      id="rent"
                      checked={formData.type === "rent" ? true : false}
              ...
              <div className="right-div">
                ...
                <div className="image-preview">
                  {imagesPreview.length < 1 &&
                    formData.images.map((image, ind) => {
                      return (
                        <img src={image.url} alt="image-preview" key={ind} />
                      );
                    })}
                </div>
